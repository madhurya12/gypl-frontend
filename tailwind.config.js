...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Primary: deep teal — calm, premium, yoga-appropriate
        primary: {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
        ...
        // Secondary: warm amber — for highlights, prizes, accents
        secondary: {
          50: '#fffbeb',
          100: '#fef3c7',
          200: '#fde68a',
        ...
        // Yoga: kept as a brand alias to teal/primary for backward-compat
        yoga: {
          50: '#f0fdfa',
          100: '#ccfbf1',
          500: '#14b8a6',
      ...
      boxShadow: {
        ...
        'soft-xl': '0 20px 40px -12px rgb(0 0 0 / 0.12)',
      },
      backdropBlur: {
        xs: '2px',
      },
